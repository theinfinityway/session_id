...
describe("Blinded ID (legacy)", () => {
    ...
    test("Generation #1", () => {
        let result = a.generateBlindedId(id, pk)
    ...
    test("Generation #2", () => {
        let result = a.generateBlindedId(id2, pk)
    ...
    test("Unblind #1", () => {
        ...
        expect(
            a.unblind15(id, 'ac9c872e525a58970df6971655abb944a30b38853442a793b29843d20795e840').toString()
    ...
    test("Unblind #2", () => {
        ...
        expect(
            a.unblind15(id, '8948f2d9046a40e7dbc0a4fd7c29d8a4fe97df1fa69e64f0ab6fc317afb9c945').toString()
        ).toBe("057aeb66e45660c3bdfb7c62706f6440226af43ec13f3b6f899c1dd4db1b8fce5b")
    })
    test("Unblind #3", () => {
        let id = new ID("1583d48386fe3adf2ff0707bcea0c028cf9eea1876e5f723fba359a24a0858fdd5")
        expect(
            a.unblind15(id, '39016f991400c35a46e11e06cb2a64d6d8ab6652e484a556b14f7cf57ed7e73a').toString()
        ).toBe("05d871fc80ca007eed9b2f4df72853e2a2d5465a92fcb1889fb5c84aa2833b3b40")
    })
    test("Unblind #4", () => {
        let id = new ID("15c6807a9933310392a26de0cf9635fba1535b2b9296c9eb6a060481d51b8983a7")
        expect(
            a.unblind15(id, 'a03c383cf63c3c4efe67acc52112a6dd734b3a946b9545f488aaa93da7991238').toString()
        ).toBe("05d871fc80ca007eed9b2f4df72853e2a2d5465a92fcb1889fb5c84aa2833b3b40")
    })
    test("Unblind #5", () => {
        let id = new ID("153645531fb118086b5a5c0a6c92cbb8e65b30daa10e2ef6857683ffe05fc25194")
        expect(
            a.unblind15(id, '118df8c6c471ac0468c7c77e1cdc12f24a139ee8a07c6e3bf4e7855640dad821').toString()
