...
describe("Blinded ID (legacy)", () => {
    test("Generation #1", () => {
        const id = "fe94b7ad4b7f1cc1bb92671f1f0d243f226e115b33770465e82b503fc3e96e1f";
        const result = generateBlindedId15(id, "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789");
    ...
    test("Generation #2", () => {
        const id = "05c9a9bf178fa644d44bebf628716dc7f2df3d0842e97881962c723699152073";
        const result = generateBlindedId15(id, "abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789");
    ...
    test("Unblind #1", () => {
        const id = "264c132e2e72a9c50b7a981eac11a48b3e51ae5a0ea45ea47deb519a3fa76612";
        expect(
    ...
    test("Unblind #2", () => {
        const id = "b8543369273587555a8bd935156a76bbf9752f1dac4a8d998c2d6ddc712eb921";
        expect(
            bytesToHex(unblind15(id, '8948f2d9046a40e7dbc0a4fd7c29d8a4fe97df1fa69e64f0ab6fc317afb9c945'))
        ).toBe("7aeb66e45660c3bdfb7c62706f6440226af43ec13f3b6f899c1dd4db1b8fce5b");
    });
    test("Unblind #3", () => {
        const id = "83d48386fe3adf2ff0707bcea0c028cf9eea1876e5f723fba359a24a0858fdd5";
        expect(
            bytesToHex(unblind15(id, '39016f991400c35a46e11e06cb2a64d6d8ab6652e484a556b14f7cf57ed7e73a'))
        ).toBe("d871fc80ca007eed9b2f4df72853e2a2d5465a92fcb1889fb5c84aa2833b3b40");
    });
    test("Unblind #4", () => {
        const id = "c6807a9933310392a26de0cf9635fba1535b2b9296c9eb6a060481d51b8983a7";
        expect(
            bytesToHex(unblind15(id, 'a03c383cf63c3c4efe67acc52112a6dd734b3a946b9545f488aaa93da7991238'))
        ).toBe("d871fc80ca007eed9b2f4df72853e2a2d5465a92fcb1889fb5c84aa2833b3b40");
    });
    test("Unblind #5", () => {
        const id = "3645531fb118086b5a5c0a6c92cbb8e65b30daa10e2ef6857683ffe05fc25194";
        expect(
    ...
    test("Unblind #6", () => {
        const id = "a507e901b27d2f85606fd73f082f25ec79f0a92bd5efc586cd1c005f3ab56170";
        expect(
            bytesToHex(unblind15(id, '39016f991400c35a46e11e06cb2a64d6d8ab6652e484a556b14f7cf57ed7e73a'))
...
describe("Blinded ID (new)", () => {
    const id = hexToBytes("fe94b7ad4b7f1cc1bb92671f1f0d243f226e115b33770465e82b503fc3e96e1f");
    const id2 = hexToBytes("05c9a9bf178fa644d44bebf628716dc7f2df3d0842e97881962c723699152073");
    test("Generation #1", () => {
        expect(
